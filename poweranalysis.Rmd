...
# Resample n 1000x and calculate mean and std of dieldrin concentrations
```{r resampleexample, include=TRUE, message=FALSE, warning=FALSE, fig.width=15, fig.asp=0.5}
resample = 1000
measurement = 'D1517'
