...
print(paste("Result: There is a ",result*100, "chance the sampled mean falls outside the significant of 0.05%. So based on a normal distribution and a z-score the power is", (1-result)*100, "?"))
```
