...
```
Result:  
0.043. There is a 4.3% chance that the sampled mean falls outside the significant of 0.05%  
1 - 0.043 = 0.957.  

So based on a normal distribution and a z-score the power is 95.7% ?
