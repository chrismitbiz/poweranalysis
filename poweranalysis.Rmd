...
Total dieldrin loss (%) since 24-30 years was recorded per paddock. The samples were taken in 12 paddocks in two different soils, with three field replicates at representative areas of each paddock. So overall the data consists of:   
  
- 2 soils
  - 12 paddocks (7 + 5)
    - 36 samples (3 per paddock, 21 + 15)  
  
Dieldrin residue concentrations (µg/g soil) and other soil measurements were measured for all samples (n = 36) but dieldrin loss (%) was available per paddock only (n = 12). 
...
# The question 1
From the available 36 samples, how certain  
